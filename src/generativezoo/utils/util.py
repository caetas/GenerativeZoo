...
def parse_args_NCSNPlusPlus():
    ...
    argparser.add_argument('--n_epochs', type=int, default=100, help='number of epochs')
    argparser.add_argument('--lr', type=float, default=0.0002, help='learning rate')
    argparser.add_argument('--ch_mult', type=int, nargs='+', default=[1, 1, 2, 2], help='channel multiplier')
    argparser.add_argument('--num_res_blocks', type=int, default=4, help='number of residual blocks')
    argparser.add_argument('--attn_resolutions', type=int, nargs='+', default=[16], help='attention resolutions')
    argparser.add_argument('--resamp_with_conv', action='store_true', default=False, help='resample with conv')
    argparser.add_argument('--conditional', action='store_true', default=False, help='conditional')
    argparser.add_argument('--fir', action='store_true', default=False, help='fir')
    argparser.add_argument('--fir_kernel', type=int, nargs='+', default=[1,3,3,1] , help='fir kernel')
    argparser.add_argument('--skip_rescale', action='store_true', default=False, help='skip rescale')
    argparser.add_argument('--resblock_type', type=str, default='biggan', help='resblock type')
    argparser.add_argument('--progressive', type=str, default='none', help='progressive', choices=['none', 'output_skip', 'residual'])
    argparser.add_argument('--progressive_input', type=str, default='residual', help='progressive input', choices=['none', 'input_skip', 'residual'])
    argparser.add_argument('--progressive_combine', type=str, default='sum', help='progressive combine', choices=['sum', 'concat'])
    argparser.add_argument('--attn_type', type=str, default='ddpm', help='attention type')
    argparser.add_argument('--embedding_type', type=str, default='positional', help='embedding type', choices=['positional', 'fourier'])
    argparser.add_argument('--init_scale', type=float, default=0.0, help='init scale')
    argparser.add_argument('--fourier_scale', type=int, default=16, help='fourier scale')
    argparser.add_argument('--conv_size', type=int, default=3, help='conv size')
    argparser.add_argument('--nf', type=int, default=128, help='number of filters')
    argparser.add_argument('--act', type=str, default='swish', help='activation', choices=['relu', 'elu', 'swish'])
    argparser.add_argument('--centered', action='store_true', default=False, help='centered')
    argparser.add_argument('--sigma_min', type=float, default=0.01, help='min value for sigma')
    argparser.add_argument('--sigma_max', type=float, default=50, help='max value for sigma')
    argparser.add_argument('--beta_min', type=float, default=0.1, help='min value for beta')
    argparser.add_argument('--beta_max', type=float, default=20, help='max value for beta')
    argparser.add_argument('--num_scales', type=int, default=1000, help='number of scales')
    argparser.add_argument('--normalization', type=str, default='GroupNorm', help='Normalization', choices=['InstanceNorm', 'GroupNorm', 'VarianceNorm', 'InstanceNorm++'])
    argparser.add_argument('--num_classes', type=int, default=10, help='number of classes')
    argparser.add_argument('--ema_decay', type=float, default=0.999, help='ema decay')
    argparser.add_argument('--continuous', action='store_true', default=False, help='continuous')
    argparser.add_argument('--reduce_mean', action='store_true', default=False, help='reduce mean')
    ...
    argparser.add_argument('--sample_and_save_freq', type=int, default=5, help='sample and save frequency')
    argparser.add_argument('--sampler', type=str, default='pc', help='sampler name', choices=['pc', 'ode'])
    argparser.add_argument('--predictor', type=str, default='em', help='predictor', choices=['none', 'em', 'rd', 'as'])
    argparser.add_argument('--corrector', type=str, default='none', help='corrector', choices=['none', 'l', 'ald'])
    argparser.add_argument('--snr', type=float, default=0.176, help='signal to noise ratio')
    argparser.add_argument('--n_steps', type=int, default=5, help='number of steps')
    argparser.add_argument('--probability_flow', action='store_true', default=False, help='probability flow')
    argparser.add_argument('--noise_removal', action='store_true', default=False, help='noise removal')
    argparser.add_argument('--scale_by_sigma', action='store_true', default=False, help='scale by sigma')
    argparser.add_argument('--dropout', type=float, default=0.2, help='dropout')
    argparser.add_argument('--sde', type=str, default='vpsde', help='sde', choices=['vpsde', 'vesde', 'subvpsde'])
    args = argparser.parse_args()
    args.ch_mult = tuple(args.ch_mult)
