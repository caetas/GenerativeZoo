...
val_loader = cifar_val_loader(batch_size=batch_size)
print(device)

# mock data for testing
x = torch.randn(1, 3, 32, 32).to(device)
model = AdversarialAE(input_shape = 32, input_channels = 3, latent_dim = 128, hidden_dims=[16,32,64,128], batch_size=batch_size).to(device)
