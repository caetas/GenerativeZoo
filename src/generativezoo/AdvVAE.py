...
if args.train:
    ...
    train_loader, input_size, channels = pick_dataset(dataset_name=args.dataset, batch_size=args.batch_size, normalize=True, size=128, num_workers=6)
    val_loader, _, _ = pick_dataset(dataset_name=args.dataset, batch_size=args.batch_size, normalize=True, mode='train', size=128, num_workers=6)
